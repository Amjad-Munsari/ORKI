...
```
Task(
  prompt="Read C:/dev/Antigravity/ORKI/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/dev/Antigravity/ORKI/.claude/get-shit-done/templates/SECURITY.md`
