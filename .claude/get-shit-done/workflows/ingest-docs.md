...
```bash
INIT=$(node "C:/dev/Antigravity/ORKI/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/dev/Antigravity/ORKI/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
