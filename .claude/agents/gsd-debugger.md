...
<required_reading>
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/Antigravity/ORKI/.claude
                  → checks C:/dev/Antigravity/ORKI/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/Antigravity/ORKI/.claude/get-shit-done
                  → writes to C:/dev/Antigravity/ORKI/.claude/get-shit-done/hooks/
...
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/common-bug-patterns.md
