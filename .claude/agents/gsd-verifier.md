...
<required_reading>
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/verification-overrides.md
...
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/references/few-shot-examples/verifier.md
