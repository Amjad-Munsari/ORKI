...
Use template from `C:/dev/Antigravity/ORKI/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/Antigravity/ORKI/.claude/get-shit-done/templates/UI-SPEC.md`
