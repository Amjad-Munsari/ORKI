...
<execution_context>
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/manager.md end-to-end.
