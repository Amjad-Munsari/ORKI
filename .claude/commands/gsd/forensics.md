...
<execution_context>
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
