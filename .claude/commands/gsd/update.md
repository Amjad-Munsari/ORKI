...
<execution_context>
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/update.md`.
...
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/sync-skills.md
@C:/dev/Antigravity/ORKI/.claude/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
