...
[testing paused — user advancing to Phase 9; 7 scenarios outstanding, 1 known major gap (cart-refresh) carried forward as Phase 8 follow-up]
...
expected: |
  /ar/shop loads with <html dir="rtl" lang="ar">. Add item, open drawer, icons/chevrons mirror correctly, all directional spacing logical (ms-/me-/ps-/pe-). Checkout shows Arabic labels and visually mirrored form, no horizontal-scroll bug. Submit valid form → land on /ar/checkout/confirmation?ref=ORK-XXXXXX with Arabic copy. Currency renders Western numerals in AR ("100.00 SAR" not "١٠٠٫٠٠").
result: [pending]
