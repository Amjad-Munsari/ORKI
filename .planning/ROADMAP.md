...
Plans:
- [ ] 11-01-PLAN.md — Wave 0: Design-system tokens (display-1..4 utilities, --container-max=1440px, near-black hex collapse to CSS vars)
...
- [ ] 11-06-PLAN.md — Wave 1: PlaceholderImage 4-variant system + deterministic slug-hash helper + ProductCard/PDPGallery wiring
- [ ] 11-07-PLAN.md — Wave 2: Home rewrites — typographic category splat (D-03), Featured-Drops ScrollReveal taming, em-dash → rtl-flip ArrowRight, shared grid scale
- [ ] 11-08-PLAN.md — Wave 2: PDP gallery upgrade — desktop vertical thumb strip + mobile scroll-snap + dots + skeleton + reduced-motion
- [ ] 11-09-PLAN.md — Wave 2: About body/pull-quote rhythm lock (D-09); keep EN 01/02/03 numbering
- [ ] 11-10-PLAN.md — Wave 2: Contact form → WhatsApp callout card; WA_NUMBER='TBD'; mock setTimeout removed
...
- [ ] 11-15-PLAN.md — Wave 4: Live `npm run dev` verification, UAT copy selection, WA_NUMBER swap, 11-VERIFICATION.md
