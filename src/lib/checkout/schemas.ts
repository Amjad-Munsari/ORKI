...
export const checkoutSchema = z.object({
  ...
  /**
   * Per-checkout-attempt idempotency key (UUID) generated by the client. Lets
   * the server dedupe double-submits so a retry/double-click returns the
   * original order instead of creating a second one or charging twice.
   */
  idempotencyKey: z.string().uuid('Checkout.errors.validation'),
});
